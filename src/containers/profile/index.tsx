    ...
    <>
      ...
      >
        ...
        <Box mt={2} backgroundColor="levelOneBg">
          ...
          />
          <Hr />
          <Text style={{ padding: 12, marginLeft: 4 }} onPress={() => navigateToContactUs()}>
            Contact Us
          </Text>
          <Hr />
          <Text style={{ padding: 12, marginLeft: 4 }} onPress={() => navigateToHelpDesk()}>
            Help Desk
          </Text>
          <Hr />
          <Text style={{ padding: 12, marginLeft: 4 }} onPress={() => navigateToPrivacyPolicy()}>
            Privacy Policy
          </Text>
          <Hr />
          <Text style={{ padding: 12, marginLeft: 4 }} onPress={() => navigateTermsCondition()}>
            Terms & Conditions
          </Text>
          <Hr />
          {/* <DetailsLinkItem
        ...
        <Hr /> */}
          ...
          />
          <Hr />
          <Text variant="heading3" style={{ padding: 12, marginLeft: 4 }}>
